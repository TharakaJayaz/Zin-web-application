                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td className={classes.td_right}><input type='text'     onChange={idInputHandler} className={classes.form_inputs} value={currntDetailsForInputs.id} /></td>
                               
                            </tr>

                            <tr>
                                <td className={classes.td_left}>Date</td>
                                <td className={classes.td_right}><input type='text'  onChange={dateInputHandler} className={classes.form_inputs} value={currntDetailsForInputs.date} /></td>
                               
                            </tr>

                            <tr>
                                <td className={classes.td_left}>Sales Rep</td>
                                <td className={classes.td_right}><input type='text' onChange={salesRepInputHandler} className={classes.form_inputs} value={currntDetailsForInputs.salesRep} /></td>
                               
                            </tr>

                            <tr>
                                <td className={classes.td_left}>Vehicle</td>
                                <td className={classes.td_right}><input type='text' onChange={vehicleInputHandler} className={classes.form_inputs} value={currntDetailsForInputs.vehicle} /></td>
                               
                            </tr>

                            <tr>
                                <td className={classes.td_left}>Route</td>
                                <td className={classes.td_right}><input type='text' onChange={routeInputHandler} className={classes.form_inputs} value={currntDetailsForInputs.route} /></td>
                               
                            </tr>
                            <tr>
                                <td className={classes.td_left}>Item List</td>
                                <td className={classes.td_right}><input type='text' onChange={itemListInputHandler} className={classes.form_inputs} value={currntDetailsForInputs.itemList} /></td>
