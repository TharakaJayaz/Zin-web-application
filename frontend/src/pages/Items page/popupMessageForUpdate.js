  ...
  const buttonHandler = async (event) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8800/updateItem",
        itemData
      );
    ...
    >
      ...
      >
        <form onSubmit={formSubmitHandler} className={classes.form_main}>
          <h2 className={classes.form_heading}>Update Item</h2>
          ...
          <div className={classes.form_button_div}>
            ...
            <button
              className={classes.form_continue}
