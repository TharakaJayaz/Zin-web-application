...
const RegisterRep = () => {
  ...
  const formSubmitHandler = (event) => {
    ...
    if (
      ...
      inputValues.reenterpassword.trim() === "" ||
      inputValues.NIC.trim() === "" ||
      inputValues.adressValue.trim() === "" ||
      inputValues.dobValue === "" ||
      inputValues.registrationdate === ""
    ) {
    ...
    console.log(
      ...
      inputValues.reenterpassword,
      inputValues.nicValue,
      inputValues.adressValue,
      inputValues.dobValue,
      inputValues.documentValue,
      inputValues.registrationdate,
      inputValues.sex
    );
    ...
    if (
      !(
        ...
        passwordValidLogic === true ||
        emailValidLogic === true ||
        nicValidLogic === true
      )
    ) {
      ...
      {!buttonLogic && (
        <div className={classes.secondry_div}>
          ...
          {/* <div className={classes.err_msg}>
            <div> <VscError className={classes.icon_style} /> <p><span className={classes.err_spn1} >Error </span> <br></br>
                                                <span className={classes.err_spn2}>your input is invalid</span></p></div>
          </div> */}
                ...
                <tr className={classes.form_tr1}>
                  ...
                  <td>
                    ...
                    <input
                      ...
                      type="text"
                      className={`${classes.form_inputs} ${
                        emailValidLogic && classes.err_style
                      }`}
                    />
                    <br></br>
                  </td>
                ...
                <tr className={classes.form_tr2}>
                  ...
                  <td>
                    ...
                    <input
                      ...
                      type="password"
                      className={`${classes.form_inputs} ${
                        passwordValidLogic && classes.err_style
                      }`}
                    />
                  </td>
                  ...
                  <td>
                    ...
                    <input
                      ...
                      type="text"
                      className={`${classes.form_inputs} ${
                        nicValidLogic && classes.err_style
                      }`}
                    />
                  </td>
                </tr>
